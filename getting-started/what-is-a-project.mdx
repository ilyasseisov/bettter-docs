...
sidebarTitle: "What is a project"
icon: "layout-grid"
...
<Info>
  On paid plans you can also connect a **custom domain** (for example `feedback.yourdomain.com`) instead of the default subdomain. Custom domain setup is covered in the Configure section (coming soon).
</Info>
...
The panel opens as a right-side sheet with accordion sections. Each section maps to a topic in the Configure docs (coming soon):
...
Continue to [Creating and managing projects](/getting-started/creating-and-managing-projects) to learn how to create, edit, open, and delete projects from the project list.
