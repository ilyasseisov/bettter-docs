...
sidebarTitle: "Creating projects"
icon: "folder-plus"
...
Continue to [Dashboard overview](/getting-started/dashboard-overview) to learn how admin navigation works inside a project and what only you can see as the owner.
