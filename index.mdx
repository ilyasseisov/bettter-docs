...
<Columns cols={2}>
  <Card title="1. Getting started" icon="rocket" href="/1.getting-started/1.1-introduction">
    What Bettter is, how projects work, and how to open your dashboard.
  </Card>
  <Card title="2. Manage content" icon="layout-list" href="/2.manage-content/2.1-creating-a-feature">
    Feature cards, roadmap, changelog, and support tickets.
  </Card>
  <Card title="3. Configure" icon="settings" href="/3.configure/3.1-primary-settings">
    Branding, SEO, custom domain, widget, and notifications.
  </Card>
  <Card title="4. Public portal" icon="globe" href="/4.public-portal/4.1-how-the-public-portal-works">
