...
| Suggest feature | **Yes** | — |
| Vote | **Yes** | — |
| Post comment | **Yes** | [Comments](/3-configure/05-controls) toggle ON |
...
See [Creating a feature](/2-manage-content/01-creating-a-feature) for field requirements.
...
See [Receiving support tickets](/2-manage-content/11-receiving-support-tickets) for delivery details.

## Next

Continue to [Signing in on the portal](/4-public-portal/03-signing-in-on-the-portal) to understand the authentication flow.
