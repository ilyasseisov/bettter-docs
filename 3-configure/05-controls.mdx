...
The **Support** toggle cannot be turned on until a valid support email is configured in [Support settings](/3-configure/04-support-settings).
...
This controls the **initial status** of visitor suggestions — not whether vote buttons appear. See [Voting](/2-manage-content/05-voting) for full voting behavior.
...
See [Comments](/2-manage-content/06-comments) for how commenting works on the portal.
...
Continue to [Custom domain](/3-configure/06-custom-domain) to connect your own hostname (paid plans).
