...
See [Receiving support tickets](/2-manage-content/11-receiving-support-tickets) for how tickets are delivered and what the public form looks like.
...
Continue to [Controls](/3-configure/05-controls) to configure tab visibility, voting moderation, comments, and navigation.
