...
You have completed Manage content. Continue to [Support settings](/3-configure/04-support-settings) to configure your support email and descriptive message.
