...
The **Open for voting** toggle lives in project settings under [Controls](/3-configure/05-controls):
...
See [Creating a feature](/2-manage-content/01-creating-a-feature) for the full suggest flow.
...
Continue to [Comments](/2-manage-content/06-comments) to enable discussion on feature detail pages.
